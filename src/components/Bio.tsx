...
const Bio = () => {
    return (
        <Section title="Bio">
            <div className=" w-[90%]">
            <p className="dark-text-l">I am a <b className="dark-text font-medium"> Computer Science Engineering </b> student set to graduate in 2025. My technical expertise spans languages such as <b className="dark-text font-medium">C, Python, JavaScript, TypeScript and GoLang</b>, along with proficiency in frameworks like <b className="dark-text font-medium">NodeJS, ReactJS, NextJS, and Express</b>. I am well-versed in tools such as <b className="dark-text font-medium">Docker, Git, Postman, Firebase, and GitLab CI</b>.</p>
            {/* <br /> */}
